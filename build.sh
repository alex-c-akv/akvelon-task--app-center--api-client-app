...
${nuget_cmd} install src/AppCenterApiClientLib/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/AppCenterApiClientLib.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/AppCenterApiClientLib.dll \
-recurse:'src/AppCenterApiClientLib/*.cs' \
-doc:bin/AppCenterApiClientLib.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/AppCenterApiClientLib.dll was created successfully"
fi
