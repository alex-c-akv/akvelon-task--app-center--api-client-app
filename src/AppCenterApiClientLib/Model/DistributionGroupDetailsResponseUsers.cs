...
{
    /// <summary>
    /// DistributionGroupDetailsResponseUsers
    /// </summary>
    [DataContract]
        public partial class DistributionGroupDetailsResponseUsers :  IEquatable<DistributionGroupDetailsResponseUsers>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DistributionGroupDetailsResponseUsers" /> class.
        /// </summary>
        ...
        public DistributionGroupDetailsResponseUsers(Guid? id = default(Guid?), string avatarUrl = default(string), bool? canChangePassword = default(bool?), string displayName = default(string), string email = default(string), bool? invitePending = default(bool?), string name = default(string))
        {
            // to ensure "email" is required (not null)
            if (email == null)
            {
                throw new InvalidDataException("email is a required property for DistributionGroupDetailsResponseUsers and cannot be null");
            }
            else
            {
                this.Email = email;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DistributionGroupDetailsResponseUsers {\n");
        ...
        {
            return this.Equals(input as DistributionGroupDetailsResponseUsers);
        }

        /// <summary>
        /// Returns true if DistributionGroupDetailsResponseUsers instances are equal
        /// </summary>
        /// <param name="input">Instance of DistributionGroupDetailsResponseUsers to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DistributionGroupDetailsResponseUsers input)
        {
            if (input == null)
                return false;
