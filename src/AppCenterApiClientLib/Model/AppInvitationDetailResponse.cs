...
namespace AppCenterApiClientLib.Model
{
        ...
        public partial class AppInvitationDetailResponse :  IEquatable<AppInvitationDetailResponse>, IValidatableObject
    {
        ...
        public AppInvitationDetailResponse(Guid? id = default(Guid?), AllOfAppInvitationDetailResponseApp app = default(AllOfAppInvitationDetailResponseApp), string email = default(string), InviteTypeEnum inviteType = default(InviteTypeEnum), AppInvitationDetailResponseInvitedBy invitedBy = default(AppInvitationDetailResponseInvitedBy), bool? isExistingUser = default(bool?), List<PermissionsEnum> permissions = default(List<PermissionsEnum>), decimal? appCount = default(decimal?), AppInvitationDetailResponseDistributionGroup distributionGroup = default(AppInvitationDetailResponseDistributionGroup))
        {
