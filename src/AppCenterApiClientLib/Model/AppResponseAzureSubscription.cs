...
{
    /// <summary>
    /// AppResponseAzureSubscription
    /// </summary>
    [DataContract]
        public partial class AppResponseAzureSubscription :  IEquatable<AppResponseAzureSubscription>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AppResponseAzureSubscription" /> class.
        /// </summary>
        ...
        public AppResponseAzureSubscription(Guid? subscriptionId = default(Guid?), Guid? tenantId = default(Guid?), string subscriptionName = default(string), bool? isBilling = default(bool?), bool? isBillable = default(bool?), bool? isMicrosoftInternal = default(bool?))
        {
            // to ensure "subscriptionId" is required (not null)
            if (subscriptionId == null)
            {
                throw new InvalidDataException("subscriptionId is a required property for AppResponseAzureSubscription and cannot be null");
            }
            else
            {
            ...
            if (tenantId == null)
            {
                throw new InvalidDataException("tenantId is a required property for AppResponseAzureSubscription and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("subscriptionName is a required property for AppResponseAzureSubscription and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AppResponseAzureSubscription {\n");
        ...
        {
            return this.Equals(input as AppResponseAzureSubscription);
        }

        /// <summary>
        /// Returns true if AppResponseAzureSubscription instances are equal
        /// </summary>
        /// <param name="input">Instance of AppResponseAzureSubscription to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppResponseAzureSubscription input)
        {
            if (input == null)
                return false;
