...
namespace AppCenterApiClientLib.Model
{
        ...
        public partial class DistributionGroupWithUsersResponse :  IEquatable<DistributionGroupWithUsersResponse>, IValidatableObject
    {
        ...
        public DistributionGroupWithUsersResponse(Guid? id = default(Guid?), string name = default(string), decimal? totalUserCount = default(decimal?), decimal? totalGroupsCount = default(decimal?), decimal? notifiedUserCount = default(decimal?), bool? isPublic = default(bool?), List<DistributionGroupDetailsResponseUsers> users = default(List<DistributionGroupDetailsResponseUsers>), List<DistributionGroupWithUsersResponseAadGroups> aadGroups = default(List<DistributionGroupWithUsersResponseAadGroups>))
        {
        ...
        public List<DistributionGroupDetailsResponseUsers> Users { get; set; }
