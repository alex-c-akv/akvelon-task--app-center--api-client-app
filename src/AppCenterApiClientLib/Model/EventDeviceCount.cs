...
namespace AppCenterApiClientLib.Model
{
        ...
        public partial class EventDeviceCount :  IEquatable<EventDeviceCount>, IValidatableObject
    {
        ...
        public EventDeviceCount(long? totalDevices = default(long?), long? totalDevicesWithEvent = default(long?), long? previousTotalDevicesWithEvent = default(long?), List<CrashCountsCrashes> devicesCount = default(List<CrashCountsCrashes>))
        {
