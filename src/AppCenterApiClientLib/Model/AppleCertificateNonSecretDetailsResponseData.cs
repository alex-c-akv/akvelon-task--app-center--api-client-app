...
namespace AppCenterApiClientLib.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AppleCertificateNonSecretDetailsResponseData :  IEquatable<AppleCertificateNonSecretDetailsResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AppleCertificateNonSecretDetailsResponseData" /> class.
        /// </summary>
        ...
        public AppleCertificateNonSecretDetailsResponseData(string displayName = default(string), string certificateValidityStartDate = default(string), string certificateValidityEndDate = default(string))
        {
            // to ensure "displayName" is required (not null)
            if (displayName == null)
            {
                throw new InvalidDataException("displayName is a required property for AppleCertificateNonSecretDetailsResponseData and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("certificateValidityStartDate is a required property for AppleCertificateNonSecretDetailsResponseData and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("certificateValidityEndDate is a required property for AppleCertificateNonSecretDetailsResponseData and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AppleCertificateNonSecretDetailsResponseData {\n");
        ...
        {
            return this.Equals(input as AppleCertificateNonSecretDetailsResponseData);
        }

        /// <summary>
        /// Returns true if AppleCertificateNonSecretDetailsResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of AppleCertificateNonSecretDetailsResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppleCertificateNonSecretDetailsResponseData input)
        {
            if (input == null)
                return false;
