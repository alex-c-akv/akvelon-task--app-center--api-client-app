...
namespace AppCenterApiClientLib.Model
{
        ...
        public partial class AppResponse :  IEquatable<AppResponse>, IValidatableObject
    {
        ...
        public AppResponse(string appSecret = default(string), AppResponseAzureSubscription azureSubscription = default(AppResponseAzureSubscription), PlatformEnum? platform = default(PlatformEnum?), OriginEnum? origin = default(OriginEnum?), string createdAt = default(string), string updatedAt = default(string), List<MemberPermissionsEnum> memberPermissions = default(List<MemberPermissionsEnum>))
        {
        ...
        public AppResponseAzureSubscription AzureSubscription { get; set; }
