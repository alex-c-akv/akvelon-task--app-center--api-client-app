...
namespace AppCenterApiClientLib.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ToolsetsXamarin :  IEquatable<ToolsetsXamarin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ToolsetsXamarin" /> class.
        /// </summary>
        ...
        public ToolsetsXamarin(string monoVersion = default(string), string sdkBundle = default(string), bool? current = default(bool?), bool? stable = default(bool?), List<string> xcodeVersions = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ToolsetsXamarin {\n");
        ...
        {
            return this.Equals(input as ToolsetsXamarin);
        }

        /// <summary>
        /// Returns true if ToolsetsXamarin instances are equal
        /// </summary>
        /// <param name="input">Instance of ToolsetsXamarin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ToolsetsXamarin input)
        {
            if (input == null)
                return false;
