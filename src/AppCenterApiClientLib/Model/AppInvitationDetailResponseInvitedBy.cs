...
{
    /// <summary>
    /// AppInvitationDetailResponseInvitedBy
    /// </summary>
    [DataContract]
        public partial class AppInvitationDetailResponseInvitedBy :  IEquatable<AppInvitationDetailResponseInvitedBy>, IValidatableObject
    {
        /// <summary>
        /// Defines Permissions
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AppInvitationDetailResponseInvitedBy" /> class.
        /// </summary>
        ...
        public AppInvitationDetailResponseInvitedBy(Guid? id = default(Guid?), string avatarUrl = default(string), bool? canChangePassword = default(bool?), string displayName = default(string), string email = default(string), string name = default(string), List<PermissionsEnum> permissions = default(List<PermissionsEnum>), OriginEnum origin = default(OriginEnum))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for AppInvitationDetailResponseInvitedBy and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (displayName == null)
            {
                throw new InvalidDataException("displayName is a required property for AppInvitationDetailResponseInvitedBy and cannot be null");
            }
            else
            {
            ...
            if (email == null)
            {
                throw new InvalidDataException("email is a required property for AppInvitationDetailResponseInvitedBy and cannot be null");
            }
            else
            {
                this.Email = email;
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for AppInvitationDetailResponseInvitedBy and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (origin == null)
            {
                throw new InvalidDataException("origin is a required property for AppInvitationDetailResponseInvitedBy and cannot be null");
            }
            else
            {
                this.Origin = origin;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AppInvitationDetailResponseInvitedBy {\n");
        ...
        {
            return this.Equals(input as AppInvitationDetailResponseInvitedBy);
        }

        /// <summary>
        /// Returns true if AppInvitationDetailResponseInvitedBy instances are equal
        /// </summary>
        /// <param name="input">Instance of AppInvitationDetailResponseInvitedBy to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppInvitationDetailResponseInvitedBy input)
        {
            if (input == null)
                return false;
