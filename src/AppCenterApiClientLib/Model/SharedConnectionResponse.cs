...
namespace AppCenterApiClientLib.Model
{
        ...
        public partial class SharedConnectionResponse :  IEquatable<SharedConnectionResponse>, IValidatableObject
    {
        ...
        public SharedConnectionResponse(string id = default(string), string displayName = default(string), ServiceTypeEnum serviceType = default(ServiceTypeEnum), CredentialTypeEnum credentialType = default(CredentialTypeEnum), bool? isValid = default(bool?), bool? is2FA = default(bool?))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for SharedConnectionResponse and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            {
                throw new InvalidDataException("credentialType is a required property for SharedConnectionResponse and cannot be null");
            }
            else
            {
