...
namespace AppCenterApiClientLib.Model
{
        ...
        public partial class RepoConfig :  IEquatable<RepoConfig>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="id">Repository configuration identifier.</param>
        /// <param name="type">Type of repository.</param>
        /// <param name="state">State of the configuration.</param>
        /// <param name="userEmail">Email of the user who linked the repository.</param>
        public RepoConfig(string id = default(string), string type = default(string), StateEnum? state = default(StateEnum?), string userEmail = default(string))
        {
            this.Id = id;
            this.Type = type;
            this.State = state;
