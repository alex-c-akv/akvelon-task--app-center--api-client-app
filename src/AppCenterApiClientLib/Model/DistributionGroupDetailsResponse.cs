...
namespace AppCenterApiClientLib.Model
{
        ...
        public partial class DistributionGroupDetailsResponse :  IEquatable<DistributionGroupDetailsResponse>, IValidatableObject
    {
        ...
        public DistributionGroupDetailsResponse(bool? isShared = default(bool?), decimal? totalAppsCount = default(decimal?), decimal? totalUserCount = default(decimal?), decimal? notifiedUserCount = default(decimal?), GroupTypeEnum? groupType = default(GroupTypeEnum?), List<DistributionGroupDetailsResponseUsers> users = default(List<DistributionGroupDetailsResponseUsers>))
        {
