...
namespace AppCenterApiClientLib.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AppleCertificateSecretDetailsResponseData :  IEquatable<AppleCertificateSecretDetailsResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AppleCertificateSecretDetailsResponseData" /> class.
        /// </summary>
        ...
        public AppleCertificateSecretDetailsResponseData(string base64Certificate = default(string), string password = default(string), string displayName = default(string), string certificateValidityStartDate = default(string), string certificateValidityEndDate = default(string))
        {
            // to ensure "base64Certificate" is required (not null)
            if (base64Certificate == null)
            {
                throw new InvalidDataException("base64Certificate is a required property for AppleCertificateSecretDetailsResponseData and cannot be null");
            }
            else
            {
            ...
            if (password == null)
            {
                throw new InvalidDataException("password is a required property for AppleCertificateSecretDetailsResponseData and cannot be null");
            }
            else
            {
            ...
            if (displayName == null)
            {
                throw new InvalidDataException("displayName is a required property for AppleCertificateSecretDetailsResponseData and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("certificateValidityStartDate is a required property for AppleCertificateSecretDetailsResponseData and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("certificateValidityEndDate is a required property for AppleCertificateSecretDetailsResponseData and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AppleCertificateSecretDetailsResponseData {\n");
        ...
        {
            return this.Equals(input as AppleCertificateSecretDetailsResponseData);
        }

        /// <summary>
        /// Returns true if AppleCertificateSecretDetailsResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of AppleCertificateSecretDetailsResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppleCertificateSecretDetailsResponseData input)
        {
            if (input == null)
                return false;
