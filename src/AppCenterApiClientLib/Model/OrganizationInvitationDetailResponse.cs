...
namespace AppCenterApiClientLib.Model
{
        ...
        public partial class OrganizationInvitationDetailResponse :  IEquatable<OrganizationInvitationDetailResponse>, IValidatableObject
    {
        ...
        public OrganizationInvitationDetailResponse(Guid? id = default(Guid?), V01invitationssentOrganization organization = default(V01invitationssentOrganization), string email = default(string), AppInvitationDetailResponseInvitedBy invitedBy = default(AppInvitationDetailResponseInvitedBy), bool? isExistingUser = default(bool?), string role = default(string))
        {
